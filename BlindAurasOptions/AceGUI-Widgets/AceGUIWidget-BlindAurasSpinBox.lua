...
Spin Box Widget
-------------------------------------------------------------------------------]]
local Type, Version = "BlindAurasSpinBox", 1
...
local progressLeftOffset = BlindAuras.IsClassicOrBCCOrWrath() and -2 or -3
local progressExtraWidth = BlindAuras.IsClassicOrBCCOrWrath() and -2 or 0
local progressTopOffset = BlindAuras.IsClassicOrBCCOrWrath() and -3 or -2
local progressBottomOffset = BlindAuras.IsClassicOrBCCOrWrath() and 3 or 2
...
local function Constructor()
  ...
  leftbutton:SetSize(16, 16)
	leftbutton:SetNormalTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxleft")
  leftbutton:SetHighlightTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxlefth")
	leftbutton:SetPushedTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxleftp")
	leftbutton:SetDisabledTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxleftp")
  leftbutton:SetScript("OnClick", SpinBox_OnValueDown)

  local rightbutton = CreateFrame("Button", nil, frame)
  rightbutton:SetSize(16, 16)
	rightbutton:SetNormalTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxright")
  rightbutton:SetHighlightTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxrighth")
	rightbutton:SetPushedTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxrightp")
	rightbutton:SetDisabledTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxrightp")
  ...
  progressBar:SetTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\spinboxoverlay")
  ...
  progressBarHandleTexture:SetTexture("Interface\\AddOns\\BlindAuras\\Media\\Textures\\Square_White")
