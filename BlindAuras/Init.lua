...
if not BlindAuras.IsLibsOK() then
  C_Timer.After(1, function()
    BlindAuras.prettyPrint("BlindAuras is missing necessary libraries. Please reinstall a proper package.")
  end)
end
...
function BlindAuras.RegisterRegionType(_, _, _ ,_)
end
...
function BlindAuras.RegisterRegionOptions(_, _ , _ ,_ )
end
...
function BlindAuras.StartProfile(_)
end
