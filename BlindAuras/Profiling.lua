...
local function CreateProfilePopup()
  ...
  if BlindAurasSaved.ProfilingWindow then
    scrollFrame:SetPoint("TOPLEFT", UIParent, "TOPLEFT", BlindAurasSaved.ProfilingWindow.xOffset or 0,
                                                         BlindAurasSaved.ProfilingWindow.yOffset or 0)
  else
...
function RealTimeProfilingWindow:Init()
  ...
  if BlindAurasSaved.RealTimeProfilingWindow then
    self:SetPoint("TOPLEFT", UIParent, "TOPLEFT",
                  BlindAurasSaved.RealTimeProfilingWindow.xOffset or 0,
                  BlindAurasSaved.RealTimeProfilingWindow.yOffset or 0)
  else
    self:SetPoint("TOPLEFT", UIParent, "TOPLEFT")
  end
  self:Show()
